...
} from '@/server/actions/investment-actions';
...
export default function InvestmentsPage() {
  ...
  if (
    retirementConfigQuery.isLoading ||
    financialProjectsQuery.isLoading ||
        ...
        actions={
          <div className="flex gap-2">
            ...
            >
              ...
              {upsertRetirementConfig.isPending
                ? 'Salvando...'
                : 'Salvar Simulação'}
            </Button>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigChange('currentAge', +e.target.value)
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigChange('retirementAge', +e.target.value)
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="number"
                    value={config.desiredMonthlyIncome}
                    onChange={(e) =>
                      handleConfigChange(
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigChange('monthlyInvestment', +e.target.value)
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    type="number"
                    step="0.1"
                    value={config.accumulationRate}
                    onChange={(e) =>
                      handleConfigChange('accumulationRate', +e.target.value)
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigChange('retirementRate', +e.target.value)
                    }
                  />
                </div>
              </div>
            ...
            {projects.length === 0 ? (
              <div className="col-span-full border-2 border-dashed rounded-2xl p-12 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground max-w-xs mx-auto text-sm">
                    Clique em "Novo Projeto" para começar a planejar suas
                    grandes conquistas.
                  </p>
                </div>
                <Button
              ...
              projects.map((project: any) => {
                const progress = Math.min(
                  (project.accumulatedValue / project.targetValue) * 100,
                  100,
                );
                return (
                  <div
                    key={project.id}
                    className="bg-card rounded-2xl border shadow-sm p-5 space-y-4 hover:shadow-md transition-shadow relative overflow-hidden group"
                  >
                      ...
                      <div className="flex justify-between text-[11px] font-medium pt-1">
                        <span className="text-primary truncate">
                          {new Intl.NumberFormat('pt-BR', {
                            style: 'currency',
                            currency: 'BRL',
                          }).format(project.accumulatedValue)}
                        </span>
                    ...
                    <div className="pt-2 border-t flex items-center justify-between">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 text-[11px] font-bold group-hover:bg-primary/5 text-primary"
                      >

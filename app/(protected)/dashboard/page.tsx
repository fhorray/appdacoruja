    ...
    <div className="space-y-6 animate-in fade-in-50 duration-500 pb-10">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <Button
            variant="outline"
            className="h-16 rounded-2xl bg-emerald-50/50 border-emerald-100 hover:bg-emerald-50 hover:border-emerald-200 text-emerald-700 flex flex-col items-center justify-center gap-1"
          >
        ...
        >
          <Button
            variant="outline"
            className="h-16 rounded-2xl bg-red-50/50 border-red-100 hover:bg-red-50 hover:border-red-200 text-red-700 flex flex-col items-center justify-center gap-1"
          >
            <div className="flex items-center gap-2 font-bold uppercase tracking-wider text-[10px]">
              <PlusCircle className="w-4 h-4" />
              Despesa
